...
RUN apt-get-min update && \
    apt-get-install-min curl cassandra=2.1.7 cassandra-tools=2.1.7
...
ADD https://github.com/glerchundi/kubernetes-cassandra-seed-provider/releases/download/v0.1.3/kubernetes-cassandra-0.1.3.jar /kubernetes-cassandra.jar
