...
# kubernetes cassandra seed provider
ADD https://github.com/glerchundi/kubernetes-cassandra-seed-provider/releases/download/v0.1.1/kubernetes-cassandra-0.1.1.jar /kubernetes-cassandra-without-deps.jar
